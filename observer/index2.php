                                        ...
                                        <tr>
                                          <td class="<?php echo $color; ?>"><div class="card">
                                            <div class="card-header">
                                              <h5>Election Results <?php echo $section2; ?></h5>
...
while($row = mysql_fetch_array($sql2)) {
   ...
   //$_SESSION['name'] = $a_post;
	   ?>                                                       <tbody> 
                                                          <tr>
                                                            <td> 
<?php //include('g_result.php'); ?>
<iframe src="g_result3.php?a_post=<?php echo $a_post; ?>" name="I1" width="100%" marginwidth="1" height="600" marginheight="1" scrolling="Yes" frameborder="0" class="mtable" id="I1" border="0"> Your browser does not support inline frames or is currently configured not to display inline frames. </iframe></td>
                                                          </tr>
                                                        </tbody>

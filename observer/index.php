...
$sqld = mysql_query("select * from instruction where sch_session = '$section'");
...
<div class="main-body">
 ...
 <?php
$sql2 = mysql_query("select * from o_name order by s_no asc");
while($row = mysql_fetch_array($sql2)) {
	$sno = $row['s_no'];
	$a_post = $row['name'];
   //$_SESSION['name'] = $a_post;
	   ?>                                                       <tbody> 
                                                          <tr>
                                                            <td> 
<iframe src="g_result.php?a_post=<?php echo $a_post; ?>" name="I1" width="100%" marginwidth="1" height="800" marginheight="1" scrolling="Yes" frameborder="0" class="mtable" id="I1" border="0"> Your browser does not support inline frames or is currently configured not to display inline frames. </iframe></td>
                                                          </tr>
                                                        </tbody>

...
<div class="main-body">
 ...
 <?php
$sql2 = mysql_query("select * from o_name order by s_no desc");
...
$sqlp = mysql_query("select * from result where a_post = '$a_post1' and a_name = '$a_name' and sch_session = '$section2'");

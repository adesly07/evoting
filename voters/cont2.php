...
//Calculating the starting row number for previous page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<span class='si_filters_links'><a href='questions.php?cps=$lps'>Previous</a></span>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from o_name limit $cps, $rpp"; 
  ...
  <div id="pcoded" class="pcoded">
                                                ...
                                                <div class="card project-task">
                                                    ...
                                                    <div class="card-block p-b-10">
                                                        <div class="table-responsive">
                                                          <form name="form1" method="post" action=""><table class="table table-hover">
                                                          <thead>
                                                                    <tr>
                                                                      <th height="32" valign="top">THE POST OF PRESIDENT</th>
                                                                    </tr>
                                                                    <?php
	...
	$file_name2 = $row ['file_name'];
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <input type="radio" name="radio" id="radio" value="<?php echo $vid; ?>">                                                                          <img src="photos/<?php echo $file_name2 ?>" alt="" width="100" height="100"> <?php echo $name; ?> <?php echo $vid; ?></th>
                                                                    </tr>
                                                            </thead>
                                                                <tbody>
                                                                </tbody>
                                                                <?php } ?>
                                                            </table>  <p>                                                              <input type="submit" name="Submit" id="Submit" value="Ok" />
    ...
    { 
        ...
        { 
            ...
            echo " <span class='si_filters_links'> | </span> <span class='si_filters_links'><a href= 'questions.php?cps=$cps&lps=$lps'>Next</a></span>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>                                                                                                                                                                                    

...
$v_code = base64_encode($v_code);
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='v_result.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from result where v_code = '$v_code' order by id ASC limit $cps, $rpp "; 
...
<img src="photos/<?php echo $file_name2 ?>" alt="">                                    <span><?php echo $matric_no; ?></span>
 ...
 <span><?php echo $m_name; ?></span>                                        <span id="more-details">Voter<i class="ti-angle-down"></i></span>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-block table-border-style">
                                              <div class="table-responsive">
                                                <table class="table table-hover">
                                                  <thead>
                                                    <tr>
                                                      <th align="left"><?php //echo $v_code; ?></th>
                                                    </tr>
                                                    <tr>
...
$sql = mysql_query("select * from a_reg where name = '$a_name' and a_post = '$a_post'");
while ($row = mysql_fetch_array($sql)) {
$file = $row ['file_name'];
//$a_post = $row ['a_post'];
}
...
$a_name = str_replace($vowel,$v_replace,$a_name);
	   ?>
                                                          <tr>
                                                            <td class="<?php echo $color; ?>"><span class="main-menu-header"><img src="../aspirant/photos/<?php echo $file; ?>" alt="" width = "100" height="100" align="left"></span><a href="#"><?php echo $a_name; ?></a> <br> <?php echo strtoupper($a_post); ?></td>
                                                          </tr>
                                                        </tbody>
                                                        <?php } ?>
                                                      </table></th>

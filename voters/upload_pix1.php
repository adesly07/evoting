...
$bank = $row['bank'];
$file_name2 = $row ['file_name1'];
}

$submit = $_POST['submit'];
if($submit == "Upload Signature")
{  // text1
$sn = $_POST['sn'];
...
$query = "update reg SET  file_name1 = '$file_name', file_size1 = '$file_size', file_type1 = '$file_type' where reg_num = '$sn'";
	
        $desired_dir="signature";
	...
	if(empty($error)){
	header("Location:upload_pix1.php");
	}
}
		}
              ...
              <div class="col-md-12 col-xl-6">
                                                    ...
                                                    <div class="card-block p-b-10">
                                                        <div class="table-responsive">
                                                           <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th width="33%"><span class="main-menu-header"><img src="signature/<?php echo $file_name2 ?>" alt=""></span></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                </tbody>
                                            ...
                                            <div class="col-md-12 col-xl-6">
                                                <div class="card project-task">
                                                    <div class="card-header">
                                                        <div class="card-header-left ">
                                                          <h5><a href="#">Upload Signature</a></h5>
                                                      </div>
                                                        <div class="card-header-right">
                                                            <ul class="list-unstyled card-option">
                                                                <li><i class="icofont icofont-simple-left "></i></li>
                                                    ...
                                                    <div class="card-block p-b-10">
                                                        <div class="table-responsive">
   <form id="form1" name="form1" method="post" action="upload_pix1.php" enctype="multipart/form-data">
     <table class="table table-hover">
       <thead>
         <tr>
           <th width="33%"><span class="error"><a href="#">Upload Signature Max of 100 X 100 Pixel</a>
         ...
         <tr>
           <th>&nbsp;</th>
           <th><input type="submit" name="submit" id="submit" value="Upload Signature"></th>
         </tr>
         </thead>
       <tbody>
       </tbody>

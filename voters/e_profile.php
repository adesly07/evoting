...
//$sn = $_POST['sn'];
$mymatric = $_POST['matric_no'];
$myemail = $_POST['email'];
$sql2 = mysql_query("UPDATE reg SET email = '$myemail' where matric_no = '$mymatric'");
if($sql2){
   ...
   <form id="form1" name="form1" method="post" action="e_profile.php">
     <table class="table table-hover">
       <thead>
         <tr>
           <th width="33%">Matric Number</th>
           <th width="67%"><input name="reg_num" type="text" id="reg_num" value="<?php echo $matric_no; ?>" readonly="readonly"></th>
         </tr>
         <tr>
           <th>Name</th>
         ...
         <tr>
           <th>Email</th>
           <th><input name="gender" type="text" id="gender" value="<?php echo $email; ?>" readonly="readonly"></th>
         </tr>
         <tr>
           <th>&nbsp;</th>

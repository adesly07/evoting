...
$query = "update reg SET  file_name = '$file_name', file_size = '$file_size', file_type = '$file_type' where matric_no = '$sn'";
                                                    ...
                                                    <div class="card-block p-b-10">
                                                        <div class="table-responsive">
                                                           <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th width="33%"><span class="main-menu-header"><img src="photos/<?php echo $file_name2 ?>" alt=""></span></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                </tbody>

...
$query = "update reg SET  file_name2 = '$file_name', file_size2 = '$file_size', file_type2 = '$file_type' where reg_num = '$sn'";
	
        $desired_dir="../member/thumb";
	...
	if(empty($error)){
	header("Location:upload_pix2.php");
	}
}
		}
              ...
              <div class="col-md-12 col-xl-6">
                                                <div class="card project-task">
                                                    <div class="card-header">
                                                        <div class="card-header-left ">
                                                            <h5>My Thumb Print | <a href="e_profile.php">Back</a></h5>
                                                        </div>
                                                    ...
                                                    <div class="card-block p-b-10">
                                                        <div class="table-responsive">
                                                           <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th width="33%"><span class="main-menu-header"><img src="../member/thumb/<?php echo $file_name2 ?>" alt=""></span></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                </tbody>
                                            ...
                                            <div class="col-md-12 col-xl-6">
                                                <div class="card project-task">
                                                    <div class="card-header">
                                                        <div class="card-header-left ">
                                                          <h5><a href="upload_pix.php">Upload Thumb Print</a></h5>
                                                      </div>
                                                        <div class="card-header-right">
                                                            <ul class="list-unstyled card-option">
                                                                <li><i class="icofont icofont-simple-left "></i></li>
                                                    ...
                                                    <div class="card-block p-b-10">
                                                        <div class="table-responsive">
   <form id="form1" name="form1" method="post" action="upload_pix2.php" enctype="multipart/form-data">
     <table class="table table-hover">
       <thead>
         <tr>
           <th width="33%"><span class="error"><a href="#">Upload Thumb Print Max of 100 X 100 Pixel</a>
               <input name="sn" type="hidden" id="sn" value="<?php echo $reg_num; ?>">
           </span></th>
           <th width="67%"><input type="file" name="files[]" id="files[]"></th>
         </tr>
         <tr>
           <th>&nbsp;</th>
           <th><input type="submit" name="submit" id="submit" value="Upload Thumb Print"></th>
         </tr>
         </thead>
       <tbody>
       </tbody>

...
$id = $_REQUEST['id'];
$sql = mysql_query("update message set status = 'READ' where id = '$id'");
                                ...
                                <div class="page-body">
                                  ...
                                  <div class="card">
                                        <div class="card-header">
                                          <h5>Inbox | <a href="a_msg.php">View Messages</a></h5>
                                        ...
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                                ...
                                                                <tbody>
       <?php
$sql2 = mysql_query("select * from message where status = 'UNREAD' order by id desc");
...
if ($status == "UNREAD"){
	   ...
	   ?>
        <tr>
  <td class="<?php echo $color; ?>"><a href="message.php?id=<?php echo $mysn; ?>"><?php echo $myname; ?><br><i><?php echo $myob; ?></i><br><?php echo $mymessage; ?>   </a></td>
                                                                        <td class="<?php echo $color; ?>"><a href="message.php?id=<?php echo $mysn; ?>"><?php echo $s_date; ?>  </a> </td>
                                                                    </tr>
                                                                    </tbody>
<?php } ?>
</table>

...
$s_answer = str_replace($vowel,$v_replace,$s_answer);
$s_answer = base64_encode($s_answer);
$password = base64_encode($password);
$sql3 = mysql_query("select * from create_login where s_answer = '$s_answer'");
if(mysql_num_rows($sql3)) {
$permitted_chars = '0123456789';
//ABCDEFGHIJKLMNOPQRSTUVWXYZ
$a_code = substr(str_shuffle($permitted_chars), 0, 5);
$sql4 = mysql_query("insert into e_access set a_code = '$a_code', created_by = '$m_name', ip = '$ip', cdate = CURDATE(), ctime = CURTIME()");
$_SESSION['a_code'] = $a_code;
	header("location: r_audit.php");
} else  {
                                              ...
                                              <div class="table-responsive">
                                                <table class="table table-hover">
                                                  <thead>
                                                    ...
                                                    <tr>
                                                      <th align="left"><form name="form1" method="post" action="e_audit.php">
                                                        <input name="s_answer" type="text" id="s_answer" size="45" placeholder = "Enter your secret answer" autofocus required>

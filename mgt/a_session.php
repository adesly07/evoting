...
{  // text1
	$sess = $_POST['sess'];
$sql1 = mysql_query("insert into sch_session set schl_session = '$sess'");
if($sql1) {
...
<?php include('menu.php'); ?>
                    ...
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                         ...
                         <form id="form1" name="form1" method="post" action="a_session.php">                                   <table class="table table-hover">
                                                                <thead>
<tr>
                                                                      <th valign="top">Session</th>
                                                                      <th><input name="sess" type="text" id="sess" placeholder="Session" required class="auto" autofocus></th>
                                                                  </tr>
                                                    ...
                                                    <div class="card-block p-b-10">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
       <?php
$sql2 = mysql_query("select * from sch_session");
while($row = mysql_fetch_array($sql2)) {
	$mysection = $row['schl_session'];

...
$sql2 = mysql_query("update account set l_amt = '$l_amt', e_month = '$emonth', e_date = '$edate', status = '$status', n_priv = 'ACTIVE' where id = '$sn'");	
if($sql2) {
$sql4 = mysql_query("insert into payment set reg_num = '$reg_num', name = '$name', a_no = '$a_no', narration = 'Loan Capital', amount = '$capital', amt_pd = '$capital', d_paid = '$d_paid', month = '$month', year = '$year', status = '$status', ip = '$ip', d_user = '$m_name'");
header ('location:loan.php');	
}
}
}
                                        ...
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th><form name="form1" method="post" action="c_status1.php">
                                                                          ...
                                                                          <p>Loan Amount 
                                                                            <input type="text" name="l_amt" id="l_amt">
                                                                          </p>
                                                                          <p>Eligibility Month

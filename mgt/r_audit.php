...
$section2 = base64_encode($section);
 ...
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='r_audit.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
                                        ...
                                        <tr>
                                          <td class="<?php echo $color; ?>"><div class="card">
                                            <div class="card-header">
                                              <h5>Click <a href="d_result.php?a_code=<?php echo $a_code; ?>"><?php echo $a_code; ?> </a>to decode the result</h5>
...
$matric_no = $row['matric_no'];
	...
	$s_no = $row['s_no'];
	   ...
	   ?>
                                                          <tr>
                                                            ...
                                                            <td class="<?php echo $color; ?>"><?php echo $v_code; ?></td>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='r_audit.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?>

...
$id = $_REQUEST['id'];
$sql1 = mysql_query("select * from testimony where id = '$id'");
...
$sn = $_POST['sn'];	
$status = $_POST['status'];
$sql2 = mysql_query("update testimony set status = '$status' where id = '$sn'");	
if($sql2) {
                                        ...
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th><form name="form1" method="post" action="c_status7.php">

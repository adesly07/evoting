...
$msg = "Set date and time for $section election";
$submit = $_POST['submit'];
if($submit)
{  // text1
$s_date = $_POST['s_date'];
...
$sql1 = mysql_query("insert into instruction set starttime = '$s_date', endtime = '$e_date', sch_session = '$section'");
if($sql1) {
$msg = "Date and time has been set for election.";	
}
else {
die(mysql_error());	
}
...
<?php include('menu.php'); ?>
                    ...
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                         ...
                         <form id="form1" name="form1" method="post" action="a_inflow.php">                                   <table class="table table-hover">
                                                                <thead>
                                                                      <th valign="top">Start Date</th>
                                                                      <th><input type="text" name="s_date" id="s_date" readonly="readonly" maxlength="25" size="25" value="<?php echo date("Y/m/d H:i:s"); ?>" /><img src="images2/cal.gif" alt="" style="cursor:pointer" onclick="javascript:NewCssCal('s_date','yyyyMMdd','arrow',true)"/></th>
                                                                    </tr>
                                                                    <tr>
                                                                      <th valign="top">End Date</th>
                                                                      <th> <input type="text" name="e_date" id="e_date" readonly="readonly" maxlength="25" size="25" />
                  <img src="images2/cal.gif" alt="" style="cursor:pointer" onclick="javascript:NewCssCal('e_date','yyyyMMdd','arrow',true)"/></th>
                                                                    </tr>
                                                                    <tr>
                                                                      <th valign="top">&nbsp;</th>
                                            ...
                                            <div class="col-md-12 col-xl-6">
                                                <div class="card project-task">
                                                    <div class="card-header">
                                                        <div class="card-header-left ">
                                                            <h5>Date and time for <?php echo $section; ?> election</h5>
                                                        </div>
                                                        <div class="card-header-right">
                                                            <ul class="list-unstyled card-option">
                                                                <li><i class="icofont icofont-simple-left "></i></li>
                                                    ...
                                                    <div class="card-block p-b-10">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
       <?php
$sql2 = mysql_query("select * from instruction");
while($row = mysql_fetch_array($sql2)) {
	$mystime = $row['starttime'];
	$myetime = $row['endtime'];
	$mysection = $row['sch_session'];

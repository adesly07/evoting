...
$c_name = str_replace($vowel,$v_replace,$c_name);
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        <span class="text-c-yellow f-w-600"><?php echo $c_name; ?></span>
                           <h6><?php echo $matric_no; ?><br>
                           <?php echo $gender; ?>
                             </h6>
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        <span class="text-c-blue f-w-600"><a href="#">Picture</a></span>
                           <h6><img src="../aspirant/photos/<?php echo $file_name2 ?>" alt="" width="100" height="100"> </h6>                             
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        <span class="text-c-pink f-w-600">Post</span>
                                                        <h6><?php echo $a_post; ?></h6>
                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card widget-card-1">
                                                    <div class="card-block-small">
                                                        <span class="text-c-green f-w-600">Phone Number</span>
                                            ...
                                            <!-- Email Sent End -->
                                            <!-- Data widget start --><!-- Data widget End -->

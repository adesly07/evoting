...
$sql1 = mysql_query("select * from a_reg where matric_no = '$matric_no'");
...
$sql = mysql_query("update a_reg set status = '$status' where matric_no = '$matric_no'");
if ($sql)	{
                                        ...
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th><form name="form1" method="post" action="c_status.php">
                                                                        
      <select name="status" id="status">
<option value="Disallow" selected>Disallow</option>
<option value="Allow">Allow</option>
      </select>
      <input name="matric_no" type="hidden" id="matric_no" value="<?php echo $matric_no; ?>">

...
$msg = "Update Current Session";
$submit = $_POST['submit'];
if($submit)
{  // text1
	$sess = $_POST['section'];
	$r_sta = $_POST['r_status'];
	$period = $_POST['period'];
$sql1 = mysql_query ("update current set status = '$r_sta', sch_session = '$sess', period = '$period'");
if($sql1) {
...
<?php include('menu.php'); ?>
                    ...
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                         ...
                         <form id="form1" name="form1" method="post" action="u_current.php">                                   <table class="table table-hover">
                                                                <thead>
<tr>
  <th valign="top">Session</th>
  <th><select name="section" id="section">
    <?php 
			while($data = dbFetchAssoc($result3)){
			?>
    <option value="<?php echo $data['schl_session']; ?>"><?php echo $data['schl_session']; ?></option>
    <?php 
			}//while
			?>
  </select></th>
...
<tr>
                                                                      <th valign="top">Result Status</th>
                                                                      <th><select name="r_status" id="r_status">
                                                    ...
                                                    <div class="card-block p-b-10">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
       <?php
$sql2 = mysql_query("select * from current");

...
$id = $_REQUEST['id'];
$sql1 = mysql_query("select * from payment where id = '$id'");
...
$sn = $_POST['sn'];	
$status = $_POST['status'];
$sql2 = mysql_query("update payment set status = '$status', d_user = '$m_name' where id = '$sn'");	
if($sql2) {
header ('location:p_loan.php');	
}
                                        ...
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th><form name="form1" method="post" action="c_status3.php">

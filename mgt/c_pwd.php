...
$sql2 = mysql_query ("update create_login set password = '$pwd' where cid = '$sn' ");
if ($sql2) {
...
<?php include('menu.php'); ?>
                                                ...
                                                <div class="card project-task">
                                                    <div class="card-header">
                                                        <div class="card-header-left ">
                                                            <h5>My Login Details | <a href="c_user.php">Create User</a></h5>
                                                        </div>
                                                        ...
                                                        <div class="table-responsive">
                                                           <table class="table table-hover">
                                                                <thead>
                                                                    ...
                                                                    <tr>
                                                                      <th>Password</th>
                                                                      <th><?php echo base64_encode($password); ?></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                </tbody>
   ...
   <form id="form1" name="form1" method="post" action="c_pwd.php">
     <table class="table table-hover">
       <thead>
           <tr>
           <th width="33%"><span class="error">Name
           </span></th>
           <th width="67%"><input name="name" type="text" id="name" value="<?php echo $m_name; ?>" readonly="readonly"></th>
         </tr>  <tr>
           <th width="33%"><span class="error"><a href="#">Old Password</a>
               <input name="sn" type="hidden" id="sn" value="<?php echo $cid; ?>">
           </span></th>
           <th width="67%"><input name="password" type="password" id="password" value="<?php echo $password; ?>" readonly="readonly"></th>
         </tr>
         <tr>
           <th>New Password</th>

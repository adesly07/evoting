...
$myprofile = stripslashes($myprofile);
$vowel2 = array('4', '3', '7', '1', '9');
$v_replace2 = array ('a', 'e', 'i', 'o', 'u');
$myprofile = str_replace($vowel2,$v_replace2,$myprofile);
...
$manif = str_replace($vowel1,$v_replace1,$manif);

$sql2 = mysql_query("UPDATE a_reg SET a_profile = '$manif' where matric_no = '$m_encode'");
if($sql2){
              ...
              <div class="col-md-12 col-xl-6">
                                                    ...
                                                    <div class="card-block p-b-10">
                                                        <div class="table-responsive">
                                                           <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th width="33%">Matric Number</th>
                                                                        <th width="67%"><?php echo $matric_no; ?></th>
                                                                    </tr>
                                                                    <tr>
                                                                      <th>Name</th>
                                                                    ...
                                                                    <tr>
                                                                      <th colspan="2"><input name="declare" type="checkbox" disabled value="" checked> I declare that the above information is true and <br>
                                                                        correct to the best of my knowledge.</th>
                                                                    </tr>
                                                                    <tr>
                                                                      <th colspan="2"></th>
                                                                    </tr>
                                            ...
                                            <div class="col-md-12 col-xl-6">
                                                <div class="card project-task">
                                                    <div class="card-header">
                                                        <div class="card-header-left ">
                                                            <h5>Edit Profile | <a href="upload_pix.php">Upload Passport</a> | </h5>
                                                        </div>
                                                        <div class="card-header-right">
                                                            <ul class="list-unstyled card-option">
                                                                <li><i class="icofont icofont-simple-left "></i></li>
   ...
   <form id="form1" name="form1" method="post" action="e_profile.php">
     <table class="table table-hover">
       <thead>
         <tr>
           <th width="33%">Matric Number</th>
           <th width="67%"><input name="matric_no" type="text" id="matric_no" value="<?php echo $matric_no; ?>" readonly="readonly"></th>
         </tr>
         <tr>
           <th>Name</th>
           <th><input name="name" type="text" id="name" value="<?php echo $m_name; ?>" readonly="readonly"></th>
         </tr>
         <tr>
           <th>Phone Number</th>
         ...
         <tr>
           <th>Gender</th>
           <th><input name="gender" type="text" id="gender" value="<?php echo $gender; ?>" readonly="readonly"></th>
         </tr>
         <tr>
           <th valign="top">Manifesto</th>
           <th><textarea name="manif" id="manif" cols="45" rows="10"><?php echo $myprofile; ?></textarea></th>
         </tr>
         <tr>
           <th>&nbsp;</th>

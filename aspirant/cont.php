...
<form name="form1" method="post" action="process.php"><table class="table table-hover">
	...
	//$s_no = $row['s_no'];
	$o_name = $row['name'];
	$sql = mysql_query("select * from a_reg where a_post = '$a_post' and sch_session = '$section'");
	while($row = mysql_fetch_array($sql)) {
...
*/																?>                                                                <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <br>                                                                        <br></th>
                                                                        <th width="17%" align="left" valign="top"><img src="photos/<?php echo $file_name2 ?>" alt="" width="100" height="100"></th>

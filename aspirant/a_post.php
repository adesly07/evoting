...
$c_by = $_POST['c_by'];
$t_post = $_POST['t_post'];
$t_post = addslashes ($t_post);
$vowel = array ('A', 'E', 'I', 'O', 'U');
$v_replace = array('4', '3', '7', '1', '9');
$c_by = str_replace($vowel,$v_replace,$c_by);
$vowel1 = array ('a', 'e', 'i', 'o', 'u');
$v_replace1 = array('4', '3', '7', '1', '9');
$t_post = str_replace($vowel1,$v_replace1,$t_post);

$ip = getenv ("REMOTE_ADDR");
$sql2 = mysql_query("insert into forum set content = '$t_post', created_by = '$c_by', matric_no = '$m_encode', sch_session = '$section', ip = '$ip', pdate = CURDATE(), ptime = CURTIME()");
...
$msg = "Error in adding post";	
 ...
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='a_post.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from forum where matric_no = '$m_encode' order by fid DESC limit $cps, $rpp "; 
    ...
    ///////////////////////////////////////////////////////////////////////////////// 
$id = $_REQUEST['fid'];
$sql1 = mysql_query("delete from forum where fid = '$id'");
if(!$sql1) {
die(mysql_error());	
                                ...
                                <div class="page-body">
                                  ...
                                  <div class="card">
                                        <div class="card-header">
                                          <h5>Add Post<a href="a_msg.php"></a></h5>
                                          <div class="card-header-right">    <ul class="list-unstyled card-option">        <li><i class="icofont icofont-simple-left "></i></li>        <li><i class="icofont icofont-maximize full-card"></i></li>        <li><i class="icofont icofont-minus minimize-card"></i></li>        <li><i class="icofont icofont-refresh reload-card"></i></li>        <li><i class="icofont icofont-error close-card"></i></li>    </ul></div>
                                        </div>
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <form name="form1" method="post" action="a_post.php">
                                                                          <textarea name="t_post" cols="25" rows="7" id="t_post" placeholder="Type in your post" autofocus="autofocus"></textarea>
                                            ...
                                            <div class="card-block table-border-style">
                                              <div class="table-responsive">
                                                <table width="100%" border="0">
                                                  <tr>
                                                    <td><b><font face="verdana" size="1" color="#9999CC"><?php echo " $a - $b of $nr0"; ?></font></b></td>
                                                  </tr>
                                                  <tr>
...
$matric = str_replace($m_number,$m_replace,$matric_no);
   $sql3 = mysql_query("select * from comment where fid = '$fid'");
$t_comment = mysql_num_rows($sql3);
	   ?>
                                                        <tr>
                                                          <td class="<?php echo $color; ?>"><?php echo $cps; ?></td>
                                                          <td class="<?php echo $color; ?>"><a href="v_cont.php?fid=<?php echo $fid; ?>"><?php echo $mycontent; ?></a></td>
                                                          <td class="<?php echo $color; ?>"><?php echo $pdate; ?></td>
                                                          <td class="<?php echo $color; ?>"><?php echo $ptime; ?></td>
                                                          <td class="<?php echo $color; ?>"><?php echo $t_comment; ?></td>
                                                          <td class="<?php echo $color; ?>"><a href="a_post.php?fid=<? echo $fid ?>" onClick="return check_deletion()"><img src="../images/delete.png" width="10" height="10" /></a></td>
                                                        </tr>
                                                      </tbody>
                                                      <?php } ?>
                                                    </table></td>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='a_post.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ///////////////////////////////////////////////////////////////////////////////// 
    ?></td>

...
<?php include('menu.php'); ?>
                                                    ...
                                                    <div class="card-block p-b-10">
                                                        <div class="table-responsive">
                                                           <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th width="33%"><span class="main-menu-header"><img src="photos/<?php echo $file_name2 ?>" alt="" width = "100" height="100"></span></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                </tbody>
   ...
   <form id="form1" name="form1" method="post" action="upload_pix.php" enctype="multipart/form-data">
     <table class="table table-hover">
       <thead>
         <tr>
           <th width="33%"><span class="error"><a href="#">Upload (Photo size must be less than 2 MB)</a>

                                        ...
                                        <div class="card-block table-border-style">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th><form name="form1" method="post" action="a_post.php">
                                                                          <textarea name="t_post" cols="35" rows="7" id="t_post" placeholder="Type in your post" autofocus="autofocus"></textarea>

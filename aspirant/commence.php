...
$v_code = substr(str_shuffle($permitted_chars), 0, 20);
...
<?php include('menu.php'); ?>
                                                ...
                                                <div class="card project-task">
                                                    <div class="card-header">
                                                        <div class="card-header-left ">
                                                            <h5><?php echo $section; ?> Election</h5>
                                                        </div>
            ...
            Start Time 
                <input type="text" id="txt" size="40" readonly="readonly" />
                  </span></th>
                                                                    </tr>
                                                                    <tr>
                                                                      <th valign="top" bgcolor="#254A74"><span style="color:#FFF;">End Time:
          <input type="text" id="txt1" size="40" readonly="readonly"  /></span>
</th>
                                                                    </tr>
                                                                    <tr>
                                                                        <th width="17%" valign="top"><iframe src="cont.php" name="I1" width="100%" marginwidth="1" height="600" marginheight="1" scrolling="Yes" frameborder="0" class="mtable" id="I1" border="0"> Your browser does not support inline frames or is currently configured not to display inline frames. </iframe>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>

...
$sql1 = mysql_query("select * from a_reg where a_post = '$a_post' and sch_session = '$section'");
while($row = mysql_fetch_array($sql1)) {
$vid = $row['vid'];	
$s_no = $row['s_no'];	
$sql5 = mysql_query("select * from result where sch_session = '$section' and s_no = '$s_no' and sch_session = '$section' and a_post = '$a_post'");
$t_count = mysql_num_rows($sql5);
$sql6 = mysql_query("select * from result where sch_session = '$section' and vid = '$vid' and sch_session = '$section' and a_post = '$a_post'");
                                                ...
                                                <div class="card project-task">
                                                    <div class="card-header">
                                                        <div class="card-header-left ">
                                                            <h5><?php echo $section; ?> election result for the post of <?php echo $a_post; ?></h5>
                                                        </div>
                                                        ...
                                                        <div class="table-responsive">
                                                          <table class="table table-hover">
                                                                <thead>
                                                                    ...
                                                                    <tr>
                                                                        <th width="17%" valign="top"><iframe src="result.php" name="I1" width="100%" marginwidth="1" height="600" marginheight="1" scrolling="Yes" frameborder="0" class="mtable" id="I1" border="0"> Your browser does not support inline frames or is currently configured not to display inline frames. </iframe>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>

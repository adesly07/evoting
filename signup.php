...
$pwd2 = base64_encode($pwd);

$sql1 = mysql_query("select * from e_list where matric_no = '$m_encode' and sch_session = '$section'");
if(!mysql_num_rows($sql1)) {
$msg = "Your matric number does not match our eligibility list. Contact Electoral Commission for complaint.";	
} else  {
	$sql2 = mysql_query("select * from reg where matric_no = '$m_encode'");
	if(mysql_num_rows($sql2)) {
$msg = "Record Already Exist. Click <a href='login.php'>here </a>to Login";		
	} else {
$sql = mysql_query("INSERT INTO reg SET matric_no = '$m_encode', password = '$pwd2', name = '$n_encode', phone_no = '$p_encode', email = '$email', declaration = '$declare', status = 'Allow', ip = '$ip', date = CURDATE()");
if($sql){
                        ...
                        <form id="form1" name="form1" method="post" action="signup.php">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group">
                                      <input name="phone_no" type="text" class="form-control" id="phone_no" maxlength="11" placeholder="Phone Number" required>
